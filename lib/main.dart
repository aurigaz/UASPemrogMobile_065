              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    AvatarFrame(
                      imageUrl: 'https://lh3.googleusercontent.com/a/ACg8ocKBIG-L-SMd_IuVyCokuvGChXvnqw4O5ttwBY2hSOKULcM=s360-c-no',
                    ),
                  ],
                ),
                SizedBox(height: 10),
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: Color.fromARGB(255, 31, 108, 112).withOpacity(0.5),
                      width: 2,
                    ),
                    boxShadow: [
                      BoxShadow(
